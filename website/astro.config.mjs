...
export default defineConfig({
  ...
  integrations: [
    ...
    starlight({
      ...
      // Starlight 0.39 removed autogenerated groups: a labelled group now
      // carries the `autogenerate` config inside its own `items`.
      sidebar: [
        {
          label: 'Guide',
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              items: [{ autogenerate: { directory: 'reference/components' } }],
            },
          ],
        },
      ],
