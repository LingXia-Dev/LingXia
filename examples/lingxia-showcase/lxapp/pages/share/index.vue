    ...
    <div class="px-3 py-3 pb-12 space-y-3">
      ...
      <div class="bg-surface rounded-lg shadow-sm">
        ...
        <div class="px-4 py-4 grid grid-cols-2 gap-3">
          <button @click="chooseImage" class="py-3 rounded-lg bg-surface-900 text-white font-medium">Choose Image</button>
      ...
      <div class="bg-surface rounded-lg shadow-sm">
        ...
        <div class="px-4 py-4 grid grid-cols-2 gap-3">
          <button @click="chooseFile" class="py-3 rounded-lg bg-surface-900 text-white font-medium">Choose File</button>
...
const PathText = defineComponent({
  ...
  setup(props) {
    return () => h(
      'div',
      { class: 'mt-2 rounded bg-surface-50 px-3 py-2 text-xs text-gray-500 break-all' },
