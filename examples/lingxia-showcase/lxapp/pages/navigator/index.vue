<template>
  <div class="min-h-screen bg-surface-50">
    <div class="px-4 py-5 space-y-4">
      <!-- Header -->
      <div class="bg-linear-to-br from-blue-500 via-blue-600 to-cyan-600 rounded-2xl px-5 py-6 shadow-lg">
        <div class="flex items-center gap-3 mb-2">
          <div class="w-10 h-10 bg-surface/20 backdrop-blur-sm rounded-xl flex items-center justify-center">
        ...
        <div class="bg-surface rounded-xl shadow-sm border border-line-100 overflow-hidden">
          <div class="p-4">
            ...
            <div class="grid grid-cols-2 gap-3">
              ...
              >
                <div class="flex flex-col items-center justify-center py-4 px-2 bg-surface-100 hover:bg-surface-200 active:bg-surface-300 text-gray-700 rounded-xl transition-colors h-full">
                  <span class="text-lg mb-1">⬅️</span>
          ...
          <!-- Switch Tab -->
          <div class="p-4 border-t border-line-100">
            ...
            <div class="grid grid-cols-3 gap-2">
              ...
              >
                <div class="py-2 px-3 bg-blue-50 hover:bg-blue-100 text-blue-600 dark:text-blue-400 rounded-lg text-xs font-medium text-center transition-colors">
                  🏠 Home
                </div>
              </LxNavigator>
              <LxNavigator
              ...
              >
                <div class="py-2 px-3 bg-purple-50 hover:bg-purple-100 text-purple-600 dark:text-purple-400 rounded-lg text-xs font-medium text-center transition-colors">
                  📡 API
                </div>
              </LxNavigator>
              <LxNavigator
              ...
              >
                <div class="py-2 px-3 bg-green-50 hover:bg-green-100 text-green-600 dark:text-green-400 rounded-lg text-xs font-medium text-center transition-colors">
                  ✓ Todo
                </div>
              </LxNavigator>
            </div>
      ...
      <div class="space-y-3">
        ...
        <div class="bg-surface rounded-xl shadow-sm border border-line-100 overflow-hidden">
          <div class="p-4 space-y-3">
            ...
            >
              <div class="w-full py-2.5 px-4 bg-linear-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white rounded-lg text-sm font-medium text-center transition-all shadow-sm">
            ...
            >
              <div class="w-full py-2.5 px-4 bg-linear-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white rounded-lg text-sm font-medium text-center transition-all shadow-sm">
                <div class="flex items-center justify-center gap-2">
                  <span>🔗</span>
            ...
            >
              <div class="w-full py-2.5 px-4 bg-linear-to-r from-surface-600 to-surface-700 hover:from-surface-700 hover:to-surface-800 text-white rounded-lg text-sm font-medium text-center transition-all shadow-sm">
                <div class="flex items-center justify-center gap-2">
                  <span>🌐</span>
      ...
      <div class="space-y-3">
        ...
        <div class="bg-surface rounded-xl shadow-sm border border-line-100 overflow-hidden">
          <div class="p-4">
            ...
            >
              <div class="w-full py-3 px-4 bg-linear-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 active:from-rose-700 active:to-pink-700 text-white rounded-xl text-sm font-medium text-center transition-all shadow-sm">
                <div class="flex items-center justify-center gap-3">
                  <div class="w-8 h-8 bg-surface/20 rounded-full flex items-center justify-center">
        ...
        <div class="p-4">
          ...
          <div v-else class="space-y-2">
            <div
              ...
              :key="`${log}-${index}`"
              class="text-xs text-gray-700 bg-surface-50 border border-line-100 rounded-lg px-3 py-2 break-all"
            >
              {{ log }}
            </div>
          </div>
      ...
      <div class="bg-blue-50 border border-blue-100 rounded-xl p-4">
        <div class="flex gap-3">
          <div class="text-blue-500 dark:text-blue-400 shrink-0 mt-0.5">
