  ...
  return (
    <div className="min-h-screen bg-surface-50">
      <div className="px-4 py-5 space-y-4">
        {/* Header */}
        <div className="bg-linear-to-br from-blue-500 via-blue-600 to-cyan-600 rounded-2xl px-5 py-6 shadow-lg">
          ...
          <div className="bg-surface rounded-xl shadow-sm border border-line-100 overflow-hidden">
            <div className="p-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <div className="flex flex-col items-center justify-center py-4 px-2 bg-surface-100 hover:bg-surface-200 active:bg-surface-300 text-gray-700 rounded-xl transition-colors h-full">
                    <span className="text-lg mb-1">⬅️</span>
            ...
            <div className="p-4 border-t border-line-100">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                >
                  <div className="py-2 px-3 bg-blue-50 hover:bg-blue-100 text-blue-600 dark:text-blue-400 rounded-lg text-xs font-medium text-center transition-colors">
                    🏠 Home
                  </div>
                </LxNavigator>
                <LxNavigator
                ...
                >
                  <div className="py-2 px-3 bg-purple-50 hover:bg-purple-100 text-purple-600 dark:text-purple-400 rounded-lg text-xs font-medium text-center transition-colors">
                    📡 API
                  </div>
                </LxNavigator>
                <LxNavigator
                ...
                >
                  <div className="py-2 px-3 bg-green-50 hover:bg-green-100 text-green-600 dark:text-green-400 rounded-lg text-xs font-medium text-center transition-colors">
                    ✓ Todo
                  </div>
                </LxNavigator>
              </div>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-surface rounded-xl shadow-sm border border-line-100 overflow-hidden">
            <div className="p-4 space-y-3">
              ...
              >
                <div className="w-full py-2.5 px-4 bg-linear-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white rounded-lg text-sm font-medium text-center transition-all shadow-sm">
              ...
              >
                <div className="w-full py-2.5 px-4 bg-linear-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white rounded-lg text-sm font-medium text-center transition-all shadow-sm">
                  <div className="flex items-center justify-center gap-2">
                    <span>🔗</span>
              ...
              >
                <div className="w-full py-2.5 px-4 bg-linear-to-r from-surface-600 to-surface-700 hover:from-surface-700 hover:to-surface-800 text-white rounded-lg text-sm font-medium text-center transition-all shadow-sm">
                  <div className="flex items-center justify-center gap-2">
                    <span>🌐</span>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-surface rounded-xl shadow-sm border border-line-100 overflow-hidden">
            <div className="p-4">
              ...
              >
                <div className="w-full py-3 px-4 bg-linear-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 active:from-rose-700 active:to-pink-700 text-white rounded-xl text-sm font-medium text-center transition-all shadow-sm">
            ...
            {logs.length === 0 ? (
              ...
              <div className="space-y-2">
                {logs.map((log, index) => (
                  <div
                    key={`${log}-${index}`}
                    className="text-xs text-gray-700 bg-surface-50 border border-line-100 rounded-lg px-3 py-2 break-all"
                  >
                    {log}
                  </div>
                ))}
