  ...
  return (
    <div className="fixed inset-0 w-screen h-screen overflow-hidden" data-testid="home-page">
      ...
      <div className="relative z-10 w-full h-full flex flex-col justify-center items-center px-5 py-16">
        ...
        <div className="max-w-full bg-white/80 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20 p-6">
          ...
          {greetingMessage && (
            <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-xl">
              <div className="flex items-start gap-3">
                ...
                <p className="min-w-0 whitespace-pre-wrap break-words text-sm text-green-700 leading-relaxed" data-testid="home-greeting">
                  {greetingMessage}
                </p>
              </div>
            </div>
