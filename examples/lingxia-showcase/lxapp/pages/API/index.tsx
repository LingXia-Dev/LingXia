        ...
        <div className="bg-surface rounded-lg shadow-sm">
          ...
          {expandedSections.bridge && (
            <div className="border-t border-line-100 bg-surface-50">
              ...
              >
                <div>
                  <div className="text-sm text-gray-700">Bridge Resilience</div>
                  <div className="text-xs text-gray-400">Bootstrap, streaming, reconnect, and teardown</div>
                </div>
                <div className="w-4 h-4 text-gray-400">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                    <path d="M9 18l6-6-6-6"/>
        ...
        <div className="bg-surface rounded-lg shadow-sm">
          ...
          {expandedSections.system && (
            <div className="border-t border-line-100 bg-surface-50">
              ...
              >
                <div>
                  <div className="text-sm text-gray-700">Product Cache</div>
                  <div className="text-xs text-gray-500 mt-0.5">Report and clear every lxapp's cache (home lxapp only)</div>
                </div>
                <div className="w-4 h-4 text-gray-400">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                    <path d="M9 18l6-6-6-6"/>
