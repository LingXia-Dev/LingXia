      ...
      <div className="px-4 py-6">
        ...
        <div className="mb-5 bg-surface rounded-2xl shadow-sm border border-line-100 overflow-hidden">
          <div className="p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-linear-to-br from-emerald-50 to-green-50">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`py-3 text-sm font-medium transition-all duration-200 rounded-xl shadow-sm active:scale-[0.98] ${wifiModuleEnabled
                  ...
                  : 'bg-linear-to-r from-green-600 to-green-500 hover:from-green-500 hover:to-green-600 text-white'
                  }`}
              >
                Start WiFi
              </button>
              <button
                ...
                className={`py-3 text-sm font-medium transition-all duration-200 rounded-xl shadow-sm active:scale-[0.98] ${!wifiModuleEnabled
                  ? 'bg-surface-200 text-gray-400 cursor-not-allowed'
                  : 'bg-linear-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-600 text-white'
                  }`}
              >
                Stop WiFi
              </button>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`px-4 py-2 text-xs font-medium transition-all duration-200 rounded-lg shadow-sm active:scale-[0.98] ${wifiListenerEnabled
                    ? 'bg-surface-200 text-gray-400 cursor-not-allowed'
                    : 'bg-linear-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-500 text-white'
                    }`}
                >
                  On
                </button>
                <button
                  ...
                  className={`px-4 py-2 text-xs font-medium transition-all duration-200 rounded-lg shadow-sm active:scale-[0.98] ${!wifiListenerEnabled
                    ? 'bg-surface-200 text-gray-400 cursor-not-allowed'
                    : 'bg-linear-to-r from-surface-600 to-surface-500 hover:from-surface-500 hover:to-surface-600 text-white'
                    }`}
                >
                  Off
                </button>
              ...
              {wifiConnectedEvents.length === 0 ? (
                ...
                <div className="space-y-3">
                  {wifiConnectedEvents.map((event) => (
                    <div
                      key={event.id}
                      className="rounded-lg border border-line-200 bg-surface p-3 text-xs text-gray-600"
                    >
        ...
        {wifiModuleEnabled && (
          <div className="mb-5 bg-surface rounded-2xl shadow-sm border border-line-100 overflow-hidden">
            <div className="flex items-center gap-4 px-5 py-5 border-b border-line-100">
              ...
              <button
                onClick={getWifiList}
                className="px-5 py-2.5 text-sm font-medium transition-all duration-200 bg-linear-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-600 text-white rounded-xl shadow-sm active:scale-[0.98]"
              >
                Scan
              </button>
            </div>
        ...
        {wifiModuleEnabled && (
          <div className="mb-5 bg-surface rounded-2xl shadow-sm border border-line-100 overflow-hidden">
            <div className="p-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-linear-to-br from-emerald-50 to-lime-50">
                  <span className="text-xl">🔗</span>
                </div>
                <div>
              ...
              <div className="space-y-3">
                <input
                  ...
                  className="w-full px-4 py-3 text-sm border border-line-200 rounded-xl bg-surface focus:outline-hidden focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
                  placeholder={
                    wifiList && Array.isArray(wifiList) && wifiList.length > 0
                ...
                <button
                  ...
                  className="w-full py-3 text-sm font-medium transition-all duration-200 bg-linear-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-600 text-white rounded-xl shadow-sm active:scale-[0.98]"
                >
                  Connect
                </button>
              </div>
