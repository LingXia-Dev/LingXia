...
export default function ComponentsPage() {
  ...
  return (
    <div className="min-h-screen bg-surface-100" data-testid="components-page">
      <div className="px-3 py-2 pb-12 space-y-2">

        {/* Compact Header */}
        <div className="bg-linear-to-r from-blue-500 to-purple-600 rounded-xl shadow-sm px-4 py-3 flex items-center gap-3">
        ...
        {/* Component List */}
        <div className="bg-surface rounded-xl shadow-sm border border-line-200 overflow-hidden divide-y divide-line-100">
          {/* Video */}
          <div
            data-testid="components-video"
            className="px-4 py-3.5 hover:bg-surface-50 cursor-pointer flex items-center justify-between group transition-colors"
          ...
          >
            ...
            <div className="w-5 h-5 text-gray-400 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-linear-to-br from-orange-500 to-rose-500 rounded-lg flex items-center justify-center">
                <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" className="w-5 h-5">
              ...
              <div>
                <div className="text-sm font-medium text-gray-900">Media Swiper</div>
                <div className="text-xs text-gray-500">Image/video carousel via chooseMedia</div>
              </div>
            </div>
            <div className="w-5 h-5 text-gray-400 group-hover:text-rose-500 dark:group-hover:text-rose-400 transition-colors">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M9 18l6-6-6-6" />
              </svg>
            </div>
          ...
          >
            ...
            <div className="w-5 h-5 text-gray-400 group-hover:text-emerald-500 dark:group-hover:text-emerald-400 transition-colors">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M9 18l6-6-6-6" />
              </svg>
            </div>
          ...
          >
            ...
            <div className="w-5 h-5 text-gray-400 group-hover:text-purple-500 dark:group-hover:text-purple-400 transition-colors">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M9 18l6-6-6-6" />
              </svg>
            </div>
