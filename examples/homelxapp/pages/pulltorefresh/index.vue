    ...
    <div class="px-4 py-6 pb-12 space-y-4">
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-4 py-5 text-center">
          ...
          <div class="text-base text-gray-900 font-medium mb-2">Pull Down Refresh Demo</div>
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="px-4 py-4 space-y-3">
          ...
          <div class="flex items-center justify-between">
            ...
            <span class="text-sm font-medium text-gray-900">{{ lastRefreshTime || 'Never' }}</span>
          </div>
        </div>
      </div>
...
const isRefreshing = computed(() => data.isRefreshing ?? false);
</script>
