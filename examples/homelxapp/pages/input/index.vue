  ...
  <div class="min-h-screen bg-gray-100">
    <div class="px-4 py-5 space-y-4">
      <header class="bg-gradient-to-r from-blue-500 to-cyan-600 rounded-xl px-4 py-4">
        <div class="text-lg text-white font-bold">Input</div>
        <div class="text-xs text-white/85 mt-1">Cross-platform input component</div>
      </header>
...
import { LxInput } from '@lingxia/vue';
import '../../tailwind.css';
