        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              ...
              className="col-span-2 py-3 text-sm font-medium transition-all duration-200 rounded-xl shadow-sm active:scale-[0.98] bg-gradient-to-r from-rose-600 to-rose-500 hover:from-rose-500 hover:to-rose-600 text-white"
            >
        ...
        <div className="p-5">
          <div className="rounded-xl border border-gray-200 bg-gradient-to-br from-gray-50 to-white p-4">
            ...
            <div className="flex justify-between items-center py-3 border-b border-gray-200 gap-4">
              ...
              <span className="text-sm font-semibold text-gray-800 px-3 py-1 bg-blue-50 rounded-lg text-right">{status}</span>
            </div>
            <div className="flex justify-between items-center py-3 border-b border-gray-200 gap-4">
            ...
            <div className="py-3">
              <div className="text-sm text-gray-600 mb-2">Access Token</div>
              <div className="text-sm font-medium text-gray-800 px-3 py-3 bg-emerald-50 rounded-lg break-all">
    ...
    <>
      <div className="mb-5 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="px-5 py-5 border-b border-gray-100">
          <div className="text-sm text-gray-800 font-semibold">Subscription</div>
          <div className="text-xs text-gray-500 mt-0.5">
        ...
        <div className="p-5 space-y-4">
          <div className="rounded-xl border border-gray-200 bg-emerald-50/60 p-4">
            ...
            <div className="mt-2 text-sm font-semibold text-gray-800">{mqttStatus}</div>
            <div className="mt-2 text-xs text-gray-500">Messages received: {mqttMessageCount}</div>
          ...
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
            ...
            <div className="mt-2 font-mono text-sm text-gray-800 break-all">{mqttTopicFilter}</div>
