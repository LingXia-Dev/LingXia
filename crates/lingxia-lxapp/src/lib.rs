...
pub use lxapp::{
    ...
    mark_lxapp_active, navbar, next_surface_context_revision, notify_lxapp_host_visibility,
    notify_page_host_visibility, notify_page_instance, notify_page_instance_by_id, on_low_memory,
    open_control_lxapp_page, open_lxapp, open_region, page_chrome, refresh_auto_appearances,
