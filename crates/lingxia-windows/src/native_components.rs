...
struct ComponentProps {
    ...
    qualities: Option<Vec<(String, Option<String>)>>,
    playback_rates: Option<Vec<f64>>,
...
fn popup_choice(owner: isize, anchor: (i32, i32), labels: &[String], checked: Option<&str>) -> Option<usize> {
