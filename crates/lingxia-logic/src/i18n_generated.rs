...
pub enum I18nKey {
    ...
    ShellPinLimitMessage,
    ShellPinLimitTitle,
    SidebarCollapse,
    SidebarExpand,
    SidebarExpandNeedsWiderWindow,
    SplashSkip,
    SurfaceClose,
    SurfaceCloseAfter,
    SurfaceCloseOthers,
...
accessible videos",
            ...
            (I18nKey::BrowserAddressPlaceholder, "en") => "Enter address",
            ...
            (I18nKey::BrowserManagePinnedSites, "en") => "Manage Pinned Sites…",
            ...
            (I18nKey::BrowserSettings, "en") => "Settings",
            (I18nKey::BrowserTabs, "en") => "Tabs",
            ...
            (I18nKey::CapsuleCleanCache, "en") => "Clear cache",
            ...
            (I18nKey::CommonForward, "en") => "Forward",
            ...
            (I18nKey::ErrCode3008, "en") => "Clipboard permission denied",
            ...
            (I18nKey::ErrCode4004, "en") => "Feature not enabled",
...
accessible videos",
            ...
            (I18nKey::ShellPinLimitMessage, "en") => "You can keep up to 8 items pinned. Unpin one before adding another.",
            (I18nKey::ShellPinLimitTitle, "en") => "Sidebar Pins",
            (I18nKey::SidebarCollapse, "en") => "Collapse sidebar",
            (I18nKey::SidebarExpand, "en") => "Expand sidebar",
            (I18nKey::SidebarExpandNeedsWiderWindow, "en") => "Widen the window first",
            (I18nKey::SplashSkip, "en") => "Skip",
            (I18nKey::SurfaceClose, "en") => "Close Tab",
            (I18nKey::SurfaceCloseAfter, "en") => "Close Tabs After",
            (I18nKey::SurfaceCloseOthers, "en") => "Close Other Tabs",
            (I18nKey::SurfaceRename, "en") => "Rename Tab",
            (I18nKey::SurfaceResetTitle, "en") => "Reset Tab Name",
            (I18nKey::TabbarMore, "en") => "More",
            ...
            (I18nKey::TerminalSearch, "en") => "Search…",
            ...
            (I18nKey::UpdateOpenStore, "en") => "Open store",
            (I18nKey::UpdateStoreMessage, "en") => "A new version is available. Update it from the store?",
            (I18nKey::UpdateStoreTitle, "en") => "Update available",
...
可访问视频",
            ...
            (I18nKey::BrowserAddressPlaceholder, "zh") => "输入网址",
            ...
            (I18nKey::BrowserManagePinnedSites, "zh") => "管理固定的站点…",
            ...
            (I18nKey::BrowserSettings, "zh") => "设置",
            (I18nKey::BrowserTabs, "zh") => "标签页",
            ...
            (I18nKey::CapsuleCleanCache, "zh") => "清缓存",
...
可访问视频",
            ...
            (I18nKey::ShellPinLimitMessage, "zh") => "最多可固定 8 项。请先取消一项，再添加新的固定项。",
            (I18nKey::ShellPinLimitTitle, "zh") => "侧栏固定项",
            (I18nKey::SidebarCollapse, "zh") => "收起侧栏",
            (I18nKey::SidebarExpand, "zh") => "展开侧栏",
            (I18nKey::SidebarExpandNeedsWiderWindow, "zh") => "窗口太窄，请先放大",
            (I18nKey::SplashSkip, "zh") => "跳过",
            (I18nKey::SurfaceClose, "zh") => "关闭标签页",
            (I18nKey::SurfaceCloseAfter, "zh") => "关闭右侧标签页",
            (I18nKey::SurfaceCloseOthers, "zh") => "关闭其他标签页",
            (I18nKey::SurfaceRename, "zh") => "重命名标签页",
            (I18nKey::SurfaceResetTitle, "zh") => "重置标签页名称",
            (I18nKey::TabbarMore, "zh") => "更多",
            ...
            (I18nKey::UpdateOpenStore, "zh") => "打开商店",
            (I18nKey::UpdateStoreMessage, "zh") => "有新版本可用，请前往商店更新。",
            (I18nKey::UpdateStoreTitle, "zh") => "发现新版本",
