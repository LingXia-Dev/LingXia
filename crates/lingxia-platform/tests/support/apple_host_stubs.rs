...
host_stub!(clipboard_write(kind: RustStr, payload: RustStr) -> *mut RustString);
host_stub!(clipboard_read(kind: RustStr, image_output_path: RustStr) -> *mut RustString);
host_stub!(clipboard_clear() -> *mut RustString);
host_stub!(clipboard_types() -> *mut RustString);
