...
pub use windows::{
    ...
    notify_windows_system_appearance_changed, register_windows_media_preview_host,
    register_windows_video_command_dispatcher, set_windows_activator_items_handler,
    set_windows_app_exit_handler, set_windows_appearance_handler, set_windows_layout_plan_handler,
