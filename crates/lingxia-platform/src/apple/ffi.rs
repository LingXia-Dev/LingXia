...
mod bridge {
    ...
    extern "Swift" {
        ...
        // Home page first render — dismiss the startup splash overlay
        ...
        #[swift_bridge(swift_name = "LxApp.takeOpenedUrlTabId")]
        fn take_opened_url_tab_id() -> String;

        #[swift_bridge(swift_name = "LxApp.closeBrowserTab")]
        fn close_browser_tab(tab_id: &str) -> bool;

        #[swift_bridge(swift_name = "LxApp.activateBrowserTab")]
        fn activate_browser_tab(tab_id: &str) -> bool;
...
pub use bridge::{
    ...
    notification_last_error, notification_request_permission, notification_show,
    ...
    request_lxapp_main_activation, review_document, set_app_badge, set_host_color_mode,
    ...
    share, show_action_sheet, show_modal, show_splash_campaign, show_surface, show_toast,
    take_opened_url_tab_id, update_navbar_ui, update_orientation_ui, update_tabbar_ui,
