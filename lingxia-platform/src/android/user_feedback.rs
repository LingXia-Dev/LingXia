...
impl UserFeedback for Platform {
    ...
    fn show_picker(
        ...
        match || -> Result<(), Box<dyn std::error::Error>> {
            ...
            let picker_class: &JClass = super::get_cached_class(super::CachedClass::LxAppPicker)?
                .as_obj()
                .into();
            ...
            match picker_type {
                PickerType::SingleColumn { items } => {
                    let string_class = env.find_class("java/lang/String")?;
                    let options_array =
                        env.new_object_array(items.len() as i32, string_class, JObject::null())?;
                    for (idx, item) in items.iter().enumerate() {
                        let option_jstring = env.new_string(item)?;
                        env.set_object_array_element(&options_array, idx as i32, option_jstring)?;
                    }
                    let options_obj: JObject = options_array.into();
                ...
                PickerType::DualColumn {
                    ...
                    let second_array_obj: JObject = second_array.into();

                    env.call_static_method(
                        picker_class,
                        "showDualColumnPicker",
                        ...
                        &[
                            JValue::Object(&first_array_obj),
                            JValue::Object(&second_array_obj),
                            JValue::Object(&cancel_text_jstring.into()),
                            JValue::Object(&cancel_button_color_jstring.into()),
                            JValue::Object(&cancel_text_color_jstring.into()),
                            JValue::Object(&confirm_text_jstring.into()),
                ...
                PickerType::DualColumnCascading {
                    ...
                    for (idx, key) in keys.iter().enumerate() {
                        ...
                        env.set_object_array_element(&values_outer, idx as i32, value_array)?;
                    }
                    let values_outer_obj: JObject = values_outer.into();
                    ...
                    env.call_static_method(
                        ...
                        &[
                            JValue::Object(&first_array_obj),
                            JValue::Object(&keys_array_obj),
                            JValue::Object(&values_outer_obj),
                            JValue::Object(&cancel_text_jstring.into()),
                            JValue::Object(&cancel_button_color_jstring.into()),
                            JValue::Object(&cancel_text_color_jstring.into()),
                            JValue::Object(&confirm_text_jstring.into()),
