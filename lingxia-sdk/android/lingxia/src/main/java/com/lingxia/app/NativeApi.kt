...
internal object NativeApi {
    ...
    /**
     * Open a tab in the shared browser's compact aside group.
     */
    @JvmStatic
     ...
     */
    @JvmStatic
    external fun findWebView(appId: String, path: String, sessionId: Long): com.lingxia.webview.LingXiaWebView?
