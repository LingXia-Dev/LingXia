...
final class DockedBrowser: NSObject {
    ...
    private enum Layout {
        // Tab geometry is shared with every aside slot strip (ChromeTabMetrics)
        // so the browser and lxapp slot headers read identical.
        static let toolbarHeight: CGFloat = ChromeTabMetrics.barHeight
        static let buttonSize: CGFloat = 28
        static let closeSize: CGFloat = 24
        static let iconSize: CGFloat = ChromeTabMetrics.iconSize
        static let edge: CGFloat = ChromeTabMetrics.edge
        static let tabHeight: CGFloat = ChromeTabMetrics.tabHeight
        static let tabIconSize: CGFloat = ChromeTabMetrics.iconSize
        static let minTabWidth: CGFloat = ChromeTabMetrics.minTabWidth
        static let maxTabWidth: CGFloat = ChromeTabMetrics.maxTabWidth
        static let tabTopInset: CGFloat = ChromeTabMetrics.tabTopInset
        static let tabFoot: CGFloat = ChromeTabMetrics.tabFoot
        static let tabCorner: CGFloat = ChromeTabMetrics.tabCorner
    }
    ...
    private func buildChrome() {
        ...
        // interlock like Chrome (foot width is Layout.tabFoot).
        tabStrip.spacing = -Layout.tabFoot
    ...
    private func buildTabRow(_ tab: Tab) {
        ...
        row.edgeInsets = NSEdgeInsets(
            top: Layout.tabTopInset + 3,
            left: Layout.tabFoot + 6,
            bottom: 3,
            right: Layout.tabFoot
        )
        ...
        icon.widthAnchor.constraint(equalToConstant: Layout.tabIconSize).isActive = true
        icon.heightAnchor.constraint(equalToConstant: Layout.tabIconSize).isActive = true
        row.heightAnchor.constraint(equalToConstant: Layout.tabHeight).isActive = true
        let minWidth = row.widthAnchor.constraint(greaterThanOrEqualToConstant: Layout.minTabWidth)
